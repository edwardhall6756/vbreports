...
Public Class Exception6
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        With ReportData1
            .RPTNAME = "Operations Exceptions 6 - Inventory 61 - 90 Days"
...
isnull((select top 1 m2.worked 
	from master m2 with(nolock) where m2.linkdriver in (0,1) 
	--and m2.qlevel<'998' 
...
where  
--Placed between 61 and 90 days ago
received between  DATEADD(day,-90,@START) and DATEADD(day,-61,@START) 
--Branch is not 2
