Public Class Exception5
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        With ReportData1
            .RPTNAME = "Operations Exceptions 5 - Inventory 31 - 60 Days"
...
where  
--Placed between 31 and 60 days ago
received between DATEADD(day,-60,@START) and DATEADD(day,-31,@START) 
--Branch is not 2
...
ELSE 0 END ) > @workDays))order by master.received desc"
        End With
    End Sub
